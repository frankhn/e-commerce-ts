...
var filter_response_1 = __importDefault(require("../../helpers/data/filter.response"));
var User = /** @class */ (function (_super) {
    __extends(User, _super);
    function User() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.model = 'User';
        _this.profile = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var customer, token, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        customer = _a.sent();
                        if (customer) {
                            token = jsonwebtoken_1.default.sign({ customer: customer }, "" + process.env.SECRETKEY);
        ...
        _this.login = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _a, email, password, customer, verify, token, error_2;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (customer.dataValues) {
                            verify = Encrypt_1.default.decrypt(password, customer.dataValues.password);
                            customer = new filter_response_1.default(customer.dataValues).select();
                            if (verify === true) {
                                token = jsonwebtoken_1.default.sign({ customer: customer }, "" + process.env.SECRETKEY);
                                res.status(StatusCodes_1.OK).json({
                                    status: StatusCodes_1.OK,
        ...
        _this.register = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _a, name_1, email, password, NewUser, user, token, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        ...
                        return [4 /*yield*/, models_1.default[this.model].create(NewUser, {
                                attributes: {
                                    exclude: [
                                        'createdAt',
                                        'updatedAt'
                    ...
                    case 1:
                        user = _b.sent();
                        if (user) {
                            user = new filter_response_1.default(user).select();
                            token = jsonwebtoken_1.default.sign({ user: user }, "" + process.env.SECRETKEY);
                    ...
                    case 2:
                        ...
                        res.status(StatusCodes_1.BAD_REQUEST).json({
                            status: StatusCodes_1.BAD_REQUEST,
                            error: error_3.errors[0].message
                        });
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
