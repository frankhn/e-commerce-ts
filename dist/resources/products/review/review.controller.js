...
var Review = /** @class */ (function (_super) {
    ...
    function Review() {
        ...
        _this.model = 'Review';
        _this.createReview = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var product_id, customer_id, _a, review, rating, data, product, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        data = {
                            customer_id: customer_id, product_id: product_id, review: review, rating: rating
                        };
                        return [4 /*yield*/, models_1.default[this.model].create(data)];
                    case 1:
                        product = _b.sent();
        ...
        _this.productReview = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
